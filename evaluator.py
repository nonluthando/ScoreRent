...
def evaluate(
    ...
    is_bursary_student: bool = False,  # ✅ NEW (explicit bursary toggle)
    ...
    # ==========================================================
    # Affordability rules
    # ✅ FIX: bursary students do NOT get 30/35% penalty.
    # ==========================================================
    if is_student and has_bursary:
        # bursary student affordability logic
        ...
        # everyone else uses standard affordability
        if non_bursary_student and guarantor_monthly_income <= 0:
            before = score
            score -= 10
            _add_breakdown(
    ...
    # ✅ FIX: avoid double payslip penalty if listing required it already
    # ==========================================================
    if renter_type == "worker":
        ...
        # bursary students: no guarantor docs
